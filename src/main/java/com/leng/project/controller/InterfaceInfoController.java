...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        // 判断该接口是否可以调用
        com.leng.lengapiclientsdk.model.User user = new com.leng.lengapiclientsdk.model.User();
        user.setUsername("test");
        // 创建LengapiClient的实例
        LengapiClient lengapiClient = new LengapiClient("xiaoleng", "abcdefg"); // 替换为你的accessKey和secretKey

        String username = lengapiClient.getUsernameByPost(user);
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        LengapiClient tempClient = new LengapiClient(accessKey, secretKey);
        Gson gson = new Gson();
